...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Menu &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.0.2" media="all">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="httplocalhost/Digital-Menu/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="httplocalhost/Digital-Menu/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to Menu</a>		</p>
			</div>
			<script src="/wp-includes/js/jquery/jquery.min.js?ver=3.6.0" id="jquery-core-js"></script>
<script src="/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
<script id="zxcvbn-async-js-extra">
var _zxcvbnSettings = {"src":"httplocalhost\/Digital-Menu\/wp-includes\/js\/zxcvbn.min.js"};
</script>
...
var _wpUtilSettings = {"ajax":{"url":"\/Digital-Menu\/wp-admin\/admin-ajax.php"}};
</script>
<script src="/wp-includes/js/wp-util.min.js?ver=6.0.2" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"a37b25bdfb"};
</script>
